...
Quintus["2D"] = function (Q) {
    ...
    Q.component('2d', {
        added: function () {
            ...
            Q._defaults(entity.p, {
                ...
                ay: 0,
                gravity: 0,
                collisionMask: Q.SPRITE_DEFAULT //ORIGINAL_CODE
            });
    ...
    Q.component('aiBounce', {
        added: function () {
            ...
            //this.entity.on("bump.up", this, "goLeft");
            //this.entity.on("bump.down", this, "goRight");
        },
...
Quintus.Input = function (Q) {
    ...
    Q.component("stepControls", {
        ...
        added: function () {
            ...
            if (!p.stepDistance) { p.stepDistance = p.speed; }
        ...
        collision: function (col) {
            var p = this.entity.p;
            /* THIS IS THE W AND H OF A TILE
            * LEARN HOW TO SET ID DYNAMIC
            */
            var _TW = 32;
            var _TH = 32;
            /****************************/
            ...
            if (p.stepping) {
                ...
                //p.x = p.origX;
                //p.y=p.origY
                // Callback last position [ORIGINAL code]
                /* Edited code*/
                //p.x = p.origX;
                //console.log("Collision Y:" + p.y);
                //p.y = p.origY;
                //console.log("back to original Y:" + p.y);
            }
...
Quintus.Scenes = function (Q) {
    ...
    */
    Q.collision = (function () {
        ...
        function collide(o1, o2, flip) {
            ...
            offset[0] = 0; 
            //o1.x + o1.cx - o2.x - o2.cx;
            offset[1] = 0; 
            //o1.y + o1.cy - o2.y - o2.cy;
    ...
    */
    Q.Stage = Q.GameObject.extend({
        ...
        _collideCollisionLayer: function (obj, collisionMask) {// i'm reading here
            var col;
        ...
        collide: function (obj, options) {
            ...
            if (Q._isObject(options)) {
                ...
                skipEvents = options.skipEvents;//original code
            } else {
            ...
            curCol = maxCol;
            while (curCol > 0 && (col = this._collideCollisionLayer(obj, collisionMask))) {// check colision and set hit to the sprite
                if (!skipEvents)
                {
                    obj.trigger('hit', col);
